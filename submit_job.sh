...
#SBATCH --container-image=registry.webis.de/code-teaching/theses/thesis-klueber/toxicity:1.0.2
...
srun --container-workdir=/tmp --container-image=registry.webis.de/code-teaching/theses/thesis-klueber/toxicity:1.0.2 python3 src/toxic-bert/main.py
